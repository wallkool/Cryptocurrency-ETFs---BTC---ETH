...
-- Bước 5: Thêm các cột MACD Line, Signal Line và Histogram_MACD vào bảng BTCO
ALTER TABLE BTCO ADD COLUMN MACD_Line DECIMAL(10, 4);
ALTER TABLE BTCO ADD COLUMN Signal_Line DECIMAL(10, 4);
ALTER TABLE BTCO ADD COLUMN Histogram_MACD DECIMAL(10, 4);

-- Bước 6: Cập nhật bảng BTCO với các giá trị MACD Line, Signal Line và Histogram_MACD từ bảng tạm thời
UPDATE BTCO AS a
