...
-- Bước 5: Thêm các cột MACD Line, Signal Line và Histogram_MACD vào bảng GBTC
ALTER TABLE GBTC ADD COLUMN MACD_Line DECIMAL(10, 4);
ALTER TABLE GBTC ADD COLUMN Signal_Line DECIMAL(10, 4);
ALTER TABLE GBTC ADD COLUMN Histogram_MACD DECIMAL(10, 4);

-- Bước 6: Cập nhật bảng GBTC với các giá trị MACD Line, Signal Line và Histogram_MACD từ bảng tạm thời
UPDATE GBTC AS a
