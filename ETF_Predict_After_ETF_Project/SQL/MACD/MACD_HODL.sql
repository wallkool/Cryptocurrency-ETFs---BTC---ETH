...
-- Bước 5: Thêm các cột MACD Line, Signal Line và Histogram_MACD vào bảng HODL
ALTER TABLE HODL ADD COLUMN MACD_Line DECIMAL(10, 4);
ALTER TABLE HODL ADD COLUMN Signal_Line DECIMAL(10, 4);
ALTER TABLE HODL ADD COLUMN Histogram_MACD DECIMAL(10, 4);

-- Bước 6: Cập nhật bảng HODL với các giá trị MACD Line, Signal Line và Histogram_MACD từ bảng tạm thời
UPDATE HODL AS a
